...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id INT, start_time DECIMAL, user_id INT,
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS times (hour INT, day INT, week INT, month INT, 
...
time_table_insert = ("""INSERT INTO times (hour, day, week, month, year, weekday) VALUES (
%s, %s, %s, %s, %s, %s)
""")
