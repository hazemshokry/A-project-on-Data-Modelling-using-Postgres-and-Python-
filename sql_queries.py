...
artist_id VARCHAR, year INT, duration numeric(10,5))
""")

artist_table_create = ("""CREATE TABLE IF NOT EXISTS artists 
(artist_id VARCHAR PRIMARY KEY,name VARCHAR,
location VARCHAR, lattitude VARCHAR, longitude VARCHAR)
""")
...
(ts TIMESTAMP PRIMARY KEY, hour INT, day INT, week INT,
...
lattitude=EXCLUDED.lattitude, longitude=EXCLUDED.longitude;
""")
...
song_select = ("""SELECT a.song_id,b.artist_id FROM songs a
...
create_table_queries = [song_table_create, artist_table_create,
                        ...
                        user_table_create, time_table_create]
